        ...
        rules: {
            ...
            messages: {
                ...
                zip: {
                    ...
                    // min: 'Zipcode must be 5 numbers.',
                    // max: 'Zipcode must be 5 numbers.',
                ...
                cardnum: {
                    ...
                    creditcard: true,
                    min: 'Card number must be 16 numbers.',
                    max: 'Card number must be 16 numbers.'
                },
                cvv: {
                    required: 'Please enter the security code on the back of the card.',
                    number: 'Numbers only, please.',
                    min: 'CVV must be 3 numbers.',
                    max: 'CVV must be 3 numbers.'
                },
                expdate: {
