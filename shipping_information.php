        ...
        <div class="container80">
            ...
            <form id="shipForm" method="post" action="purchase.php" >
                <fieldset class="shippingInfo">
                    ...
                    <input class="shipping" type="text" id="lname" name="lname"/>
                    ...
                    <input class="shipping" type="text" id="apt" name="apt"/>
                ...
                <fieldset class="billingInfo">
                    ...
                    <div class="checkbox">
                        <input class="shipping" type="checkbox" id="checkbox1"/>
                    ...
                    <input class="shipping" type="text" id="bill_address" name="bill_address"/>

                    <label for="bill_apt">Apt/Suite/Other (optional)</label>
                    <label for="bill_apt" generated="true" class="error together"></label>
                    <input class="shipping" type="text" id="bill_apt" name="bill_apt"/>
                ...
                <fieldset class="paymentInfo">
                    ...
                    <input class="shipping" type="text" id="cardname" name="cardname"/>
                    ...
                    <div class="cardNumType">
                        <div class="cardnumGrp">
                            ...
                            <input class="shipping" name="cardnum" type="number" id="cardnum"/>
                        </div>
                        <div class="cardtypeGrp">
                            <label for="visa" class="cardtype">&nbsp;</label>
                            <input class="shipping" type="text" id="visa" name="visa" class="visa" disabled/>
                        </div>
...
<!--                            <label for="expyear" class="expyear"></label>-->
                            <select class="shipping" name="expyear">
